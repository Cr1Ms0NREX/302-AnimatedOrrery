...
public class OrbitMoons : MonoBehaviour
{
    ...
    public Transform orbitCenterMoons;
    ...
    void Update()
    {
        ...
        if (!orbitCenterMoons) return;
        {
            ...
            if (orbitCenterMoons.hasChanged) UpdateOrbitPath();
        }
    }
    void UpdateOrbitPath()
    {
        ...
        for (int i = 0; i < pts.Length; i++)
        {
            ...
            Vector3 pt = new Vector3(x, 0, z) + orbitCenterMoons.position;
            pts[i] = pt;
        }
